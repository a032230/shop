...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select none">
					<ul>
						<li class="cur">
							<input type="radio" name="address" checked="checked" />邹宗明 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555 
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="address"  />邹宗明 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
					...
					<form action="/index.php/Home/Orders/add.html" method="post" class="none" name="address_form">
						<ul>
							<li>
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
						<?php $total = 0; $count = count($data); foreach($data as $k => $v): ?>
						<tr>
							<td class="col1"><a href=""><?php echo showImage($v['sm_logo']);?>
							</a>  <strong><a href=""><?php echo ($v["goods_name"]); ?></a></strong></td>
							<td class="col2">
								<?php foreach($v['gaData'] as $v1):?>
							...
							<td class="col5"><span>￥<?=$v['goods_number'] * $v['price'] ?></span></td>
						</tr>
					<?php $total += $v['goods_number'] * $v['price']; endforeach ?>
					</tbody>
					<tfoot>
						<tr>
							<td colspan="5">
		...
		<div class="fillin_ft">
			<a onclick="document.forms['address_form'].submit();" href="javascript:;"><span>提交订单</span></a>
