...
<script type="text/javascript" src="/Public/Home/js/cart1.js"></script>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
				...
				<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
					<td class="col1">
							<a href="<?php echo U('goods',array(goods_id=> $v.goods_id));?>"><?php echo showImage($v['sm_logo']);?></a>  <strong>
					...
					<td class="col5">￥<span><?php $total+=($v['goods_number'] * $v['price']); echo ($v['goods_number'] * $v['price']);?></span></td>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="<?php echo U('Orders/add');?>" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
