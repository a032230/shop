...
<body>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php if(is_array($proData)): foreach($proData as $key=>$v): ?><li>
							<dl>
								<dt><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php showImage($v['mid_logo'])?></a></dt>
								<dd><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php echo ($v["goods_name"]); ?></a></dd>
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($hotData)): foreach($hotData as $key=>$v): ?><li>
							<dl>
								<dt><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php showImage($v['mid_logo'])?></a></dt>
								<dd><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php echo ($v["goods_name"]); ?></a></dd>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($bestData)): foreach($bestData as $key=>$v): ?><li>
							<dl>
								<dt><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php showImage($v['mid_logo'])?></a></dt>
								<dd><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php echo ($v["goods_name"]); ?></a></dd>
								<dd><span>售价：</span><strong><?php echo ($v["shop_price"]); ?></strong></dd>
				...
				<div class="new none">
					<ul>
						<?php if(is_array($newData)): foreach($newData as $key=>$v): ?><li>
							<dl>
								<dt><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php showImage($v['mid_logo'])?></a></dt>
								<dd><a href="<?php echo U('goods',array('id' => $v['id']));?>"><?php echo ($v["goods_name"]); ?></a></dd>
								<dd><span>售价：</span><strong><?php echo ($v["shop_price"]); ?></strong></dd>
	...
	<div style="clear:both;"></div>
	<?php if(is_array($floor)): foreach($floor as $key=>$v): ?><!--1F 电脑办公 start -->
		...
		<div class="floor_left fl">
			...
			<div class="goodslist fl">
				<h2>
					...
					<span <?php echo ($k1 == 0 ?'class="on"' : ''); ?>><?php echo ($v1["cat_name"]); ?></span>
					<?php endforeach?>
				</h2>
				<div class="goodslist_wrap">
					<?php foreach($v['recSubCat'] as $k1 => $v1): ?>
					<div <?php echo ($k1 == 0 ? '' : "class='none'"); ?>>
						<ul>
							<?php foreach($v1['goods'] as $k2 => $v2): ?>
							<li>
								<dl>
									<dt><a href="<?php echo U('goods',array('id' => $v2['id']));?>"><?php showImage($v2['mid_logo']) ?></a></dt>
									<dd><a href="<?php echo U('goods',array('id' => $v2['id']));?>"><?php echo ($v2["goods_name"]); ?></a></dd>
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						...
						<li><a href=""><?php showImage($v1['logo'],98,35)?></a></li>
						<?php endforeach?>
					</ul>
				</div>
			</div>
	...
	<!--1F 电脑办公 start --><?php endforeach; endif; ?>
